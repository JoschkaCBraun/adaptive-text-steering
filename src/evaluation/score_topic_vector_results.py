...
'''
score_topic_vector_results.py

This script scores the topic vector summaries generated by the topic vector model.
'''
...
def score_topic_summaries(input_file_path: str) -> Optional[Dict[str, Any]]:
    """
...
def main():
    ...
    input_json_path = 'data/results/topic_vectors/topic_summaries_llama3_1b_NEWTS_train_250_articles_topic_words_20250429_031304.json'

    scored_summaries = score_topic_summaries(input_json_path)

    # Save the scored summaries to a new JSON file
    output_json_path = 'data/scores/topic_vectors/topic_summaries_llama3_1b_NEWTS_train_250_articles_topic_words_20250429_031304.json'
